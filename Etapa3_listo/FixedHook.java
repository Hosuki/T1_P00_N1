...
public class FixedHook extends PhysicsElement implements SpringAttachable{ //se agrega implements para colocar los metodos de la interfaz
   ...
   public FixedHook(double arista, double position){
      ...
      this.arist = arista;
      pos_t = position;
      springs = new ArrayList<Spring>(); //el fixedhook puede estar unido a varios resortes
   }
